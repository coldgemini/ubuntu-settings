...
globalkeys = awful.util.table.join(globalkeys,
	...
	-- 					awful.prompt.run({ prompt = "Delete tab: ", text = awful.tag.selected().name, },
	...
	-- Move Client to New Tag.
	awful.key({ modkey, }, "KP_Multiply",    function ()
                        awful.prompt.run({ prompt = "Move to tab: ", text = "", },
                        awful.screen.focused().mypromptbox.widget,
						function (s)
                            ...
                            if t == nil
                            then
                                local t = awful.tag.add(s, {screen= c.screen,layout=awful.layout.suit.fair})
                                c:tags({t})
                                t:view_only()
                            else
                                c:tags({t})
	...
	-- Rename Tag.
	awful.key({ modkey, }, "KP_Divide",    function ()
	...
	awful.key({ modkey, }, "KP_Add",    function ()
						awful.prompt.run({ prompt = "New tab: ", text = "", },
						-- mypromptbox[mouse.screen].widget,
                        awful.screen.focused().mypromptbox.widget,
						function (s)
